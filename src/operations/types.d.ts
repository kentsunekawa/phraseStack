...
export type Mutation = {
  ...
  /**
   * Delete many Phrase documents
   * @deprecated Please use the new paginated many mutation (deleteManyPhrasesConnection)
   */
   ...
   * @deprecated Please use the new paginated many mutation (publishManyPhrasesConnection)
   */
  ...
  /**
   * Unpublish many Phrase documents
   * @deprecated Please use the new paginated many mutation (unpublishManyPhrasesConnection)
   */
  ...
  /**
   * Update many phrases
   * @deprecated Please use the new paginated many mutation (updateManyPhrasesConnection)
   */
...
export type MutationDeleteManyPhrasesArgs = {
  where?: InputMaybe<PhraseManyWhereInput>;
};


export type MutationDeleteManyPhrasesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type MutationPublishManyPhrasesArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<PhraseManyWhereInput>;
};


export type MutationPublishManyPhrasesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishPhraseArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  to?: Array<Stage>;
  where: PhraseWhereUniqueInput;
...
export type MutationScheduleUnpublishPhraseArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  where: PhraseWhereUniqueInput;
...
export type MutationUnpublishManyPhrasesArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<PhraseManyWhereInput>;
};


export type MutationUnpublishManyPhrasesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: Array<Stage>;
...
export type MutationUpdateManyPhrasesArgs = {
  data: PhraseUpdateManyInput;
  where?: InputMaybe<PhraseManyWhereInput>;
};


export type MutationUpdateManyPhrasesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  data: PhraseUpdateManyInput;
  first?: InputMaybe<Scalars['Int']>;
...
export type PagePhrasesArgs = {
  ...
  last?: InputMaybe<Scalars['Int']>;
  locales?: InputMaybe<Array<Locale>>;
  orderBy?: InputMaybe<PhraseOrderByInput>;
  skip?: InputMaybe<Scalars['Int']>;
...
export type PageManyWhereInput = {
  ...
  references?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  references_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  references_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  references_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  references_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  references_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  references_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  references_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  references_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  references_starts_with?: InputMaybe<Scalars['String']>;
  scheduledIn_every?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_none?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
...
export type PhraseCreatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};
...
export type PhrasePublishedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type PhraseScheduledInArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
...
export type PhraseUpdatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};
...
export type PhraseCreateInput = {
  clbkqatl802x201umd5000qo8?: InputMaybe<PageCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  japanese: Scalars['String'];
  phrase: Scalars['String'];
  pronunciation: Scalars['String'];
...
export type PhraseCreateManyInlineInput = {
  ...
  connect?: InputMaybe<Array<PhraseWhereUniqueInput>>;
  /** Create and connect multiple existing Phrase documents */
  create?: InputMaybe<Array<PhraseCreateInput>>;
};
...
export type PhraseCreateOneInlineInput = {
  ...
  create?: InputMaybe<PhraseCreateInput>;
};
...
export type PhraseManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<PhraseWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<PhraseWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<PhraseWhereInput>>;
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  ...
  createdAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']>>>;
  createdBy?: InputMaybe<UserWhereInput>;
  documentInStages_every?: InputMaybe<PhraseWhereStageInput>;
  documentInStages_none?: InputMaybe<PhraseWhereStageInput>;
  documentInStages_some?: InputMaybe<PhraseWhereStageInput>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
  ...
  /** All values containing the given string. */
  japanese_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  japanese_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  japanese_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  japanese_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  japanese_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  japanese_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  japanese_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  japanese_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  japanese_starts_with?: InputMaybe<Scalars['String']>;
  ...
  /** All values containing the given string. */
  pronunciation_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  pronunciation_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  pronunciation_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  pronunciation_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  pronunciation_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  pronunciation_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  pronunciation_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  pronunciation_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  pronunciation_starts_with?: InputMaybe<Scalars['String']>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum PhraseOrderByInput {
  ...
  PronunciationAsc = 'pronunciation_ASC',
  PronunciationDesc = 'pronunciation_DESC',
  PublishedAtAsc = 'publishedAt_ASC',
  PublishedAtDesc = 'publishedAt_DESC',
  UpdatedAtAsc = 'updatedAt_ASC',
  UpdatedAtDesc = 'updatedAt_DESC'
...
export type PhraseUpdateInput = {
  clbkqatl802x201umd5000qo8?: InputMaybe<PageUpdateManyInlineInput>;
  japanese?: InputMaybe<Scalars['String']>;
  phrase?: InputMaybe<Scalars['String']>;
  pronunciation?: InputMaybe<Scalars['String']>;
};
...
export type PhraseUpdateManyInlineInput = {
  /** Connect multiple existing Phrase documents */
  connect?: InputMaybe<Array<PhraseConnectInput>>;
  /** Create and connect multiple Phrase documents */
  create?: InputMaybe<Array<PhraseCreateInput>>;
  /** Delete multiple Phrase documents */
  delete?: InputMaybe<Array<PhraseWhereUniqueInput>>;
  /** Disconnect multiple Phrase documents */
  disconnect?: InputMaybe<Array<PhraseWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Phrase documents */
  set?: InputMaybe<Array<PhraseWhereUniqueInput>>;
  /** Update multiple Phrase documents */
  update?: InputMaybe<Array<PhraseUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Phrase documents */
  upsert?: InputMaybe<Array<PhraseUpsertWithNestedWhereUniqueInput>>;
};
...
export type PhraseUpdateOneInlineInput = {
  ...
  update?: InputMaybe<PhraseUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Phrase document */
  upsert?: InputMaybe<PhraseUpsertWithNestedWhereUniqueInput>;
};
...
/** This contains a set of filters that can be used to compare values internally */
export type PhraseWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']>;
};
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type PhraseWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<PhraseWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<PhraseWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<PhraseWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<PhraseWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};
...
export type Query = {
  ...
  phrase?: Maybe<Phrase>;
  /** Retrieve document version */
  phraseVersion?: Maybe<DocumentVersion>;
...
export type QueryPhraseVersionArgs = {
  where: VersionWhereInput;
};
...
export type QueryPhrasesConnectionArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
